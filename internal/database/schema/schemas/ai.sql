...
--
-- Name: knowledge_bases_created_by_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--
...
--
-- Name: knowledge_bases_owner_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE knowledge_bases
ADD CONSTRAINT knowledge_bases_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: documents_created_by_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--
...
--
-- Name: documents_owner_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE documents
ADD CONSTRAINT documents_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: documents_storage_object_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE documents
ADD CONSTRAINT documents_storage_object_id_fkey FOREIGN KEY (storage_object_id) REFERENCES storage.objects (id) ON DELETE SET NULL;

--
-- Name: document_permissions_granted_by_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE document_permissions
ADD CONSTRAINT document_permissions_granted_by_fkey FOREIGN KEY (granted_by) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: document_permissions_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--
...
--
-- Name: knowledge_base_permissions_granted_by_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE knowledge_base_permissions
ADD CONSTRAINT knowledge_base_permissions_granted_by_fkey FOREIGN KEY (granted_by) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: knowledge_base_permissions_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE knowledge_base_permissions
ADD CONSTRAINT knowledge_base_permissions_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE CASCADE;

--
-- Name: providers_created_by_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE providers
ADD CONSTRAINT providers_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: chatbots_created_by_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE chatbots
ADD CONSTRAINT chatbots_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: conversations_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--
...
--
-- Name: query_audit_log_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE query_audit_log
ADD CONSTRAINT query_audit_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: retrieval_log_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE retrieval_log
ADD CONSTRAINT retrieval_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE SET NULL;

--
-- Name: user_chatbot_usage_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

ALTER TABLE user_chatbot_usage
ADD CONSTRAINT user_chatbot_usage_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE CASCADE;

--
-- Name: user_provider_preferences_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--
...
--
-- Name: user_quotas_user_id_fkey; Type: CONSTRAINT; Schema: -; Owner: -
--

...
| ------ | ------ | ------ |
| <a id="fit"></a> `fit?` | [`ImageFitMode`](/api/sdk-react/type-aliases/imagefitmode/) | How to fit the image within target dimensions (default: cover) |
| <a id="format"></a> `format?` | [`ImageFormat`](/api/sdk-react/type-aliases/imageformat/) | Output format (defaults to original format) |

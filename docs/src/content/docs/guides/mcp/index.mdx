...
The MCP server requires authentication for all requests. Two authentication methods are available:
...
- All database operations respect Row Level Security (RLS) policies when using Client Keys
